            ...
            <>
               ...
               <nav className={"navbar"}>
                ...
                <Nav.Link href={"/Home"}  id={"navLinks"} >Home<Link to={"/Home"}/></Nav.Link>
                   <NavDropdown title="Products" variant={"info"} id={"navLinks"}>
                   ...
                   <Navbar.Brand style={{color: "darkgray",fontSize:30,marginRight: 550}}>Next-Generation Car Care</Navbar.Brand>
